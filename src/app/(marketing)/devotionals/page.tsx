...
export default async function DevotionalsPage() {
  // The daily devotional is generated by the cron at 04:00 UTC (07:00 EAT) —
  // see vercel.json + src/app/api/cron/devotional. The page only reads.
  const today = await getTodayDevotional();
